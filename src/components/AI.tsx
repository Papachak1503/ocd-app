          ...
          <div className=" lg:w-2/3 w-full">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              <ol style={{ listStyleType: "disc" }} className="ml-4">
                <li>
                  ถ้าผลการพยากรณ์ lung_aca หมายความว่าเป็นโรคมะเร็งปอดชนิด aca
                </li>
                <li>
                  ถ้าผลการพยากรณ์ lung_bnt หมายความว่าเป็นปกติ
                  ไม่เป็นโรคมะเร็งปอดชนิดใด
                </li>
                <li>
                  ถ้าผลการพยากรณ์ lung_scc หมายความว่าเป็นโรคมะเร็งปอดชนิด scc
                </li>
              </ol>
            </p>
